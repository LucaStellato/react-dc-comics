import comicons from '../assets/img/buy-comics-digital-comics.png';
...
export default function Main() {
    ...
    return (
        <>
            ...
            <div className='row row-cols-1 row cols-md-3 row-cols-xl-6 g-3'>
                {
                    comics.map(comic => (
            ...
            <div className="d-flex justify-content-center " style={{ backgroundColor: '#0282f9', minHeight: '150px', color: 'white', zIndex: 1, position: 'relative' }}>
                <img src={comicons} style={{ height: '60px', marginTop: '50px' }} />
